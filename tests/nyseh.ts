...
describe("nyseh test", () => {
  ...
  const program = anchor.workspace.nyseh as anchor.Program<Nyseh>;
  ...
  const METADATA_SEED = "metadata";
	...
	const metadata = {
		name: "NYSE Hours",
		symbol: "NYSEH",
		uri: "https://copper-quick-koi-488.mypinata.cloud/ipfs/bafkreiazj2gesi6pbjd6qsrmtutq3inc64t4bjq5ex2kldryjahdxdzo5u",
		decimals: 9,
	}
